namespace KerkenezMail.Languages
{
    ...
    public static class StringKeys
    {
        ...
        public const string SettingsBatteryActiveWarning = "Settings.BatteryActiveWarning";
        ...
        public const string SettingsDownloadPath = "Settings.DownloadPath";
        public const string SettingsBrowse = "Settings.Browse";

        public const string SettingsCollapseSidebar = "Settings.CollapseSidebar";
        public const string SettingsWindowWidth = "Settings.WindowWidth";
        public const string SettingsWindowHeight = "Settings.WindowHeight";
        public const string SettingsApplySize = "Settings.ApplySize";
